    ...
    return (
      <DashboardLayout>
        <div className="p-12 text-center flex flex-col items-center justify-center space-y-3">
          ...
          <p className="text-slate-400 font-mono text-xs">Loading AI evaluation report & transcript...</p>
        </div>
      </DashboardLayout>
    );
  }
        ...
        <div className="max-w-3xl mx-auto space-y-6 font-sans py-8">
          ...
          <div className="glass-card p-10 rounded-3xl border border-slate-800 text-center space-y-4">
            ...
            <p className="text-xs text-slate-400 max-w-md mx-auto">
              Candidate <strong className="text-slate-200">{candidate?.name || 'Candidate'}</strong> has completed or attempted interview questions. Click below to generate the full AI Scorecard.
            </p>
      ...
      <div className="max-w-5xl mx-auto space-y-6 font-sans">
        ...
        <div className="glass-card p-8 rounded-3xl border border-slate-800 grid grid-cols-1 md:grid-cols-3 gap-6 items-center glow-border">
          ...
          <div className="flex flex-col items-center justify-center p-4">
            ...
            <span className="text-xs font-semibold text-slate-300 mt-2">AI Quality Score</span>
          </div>
        ...
        <div className="glass-card p-6 rounded-2xl border border-slate-800 space-y-3">
          <h3 className="text-sm font-bold text-slate-200">Executive AI Rationale Summary</h3>
          <p className="text-xs text-slate-300 leading-relaxed bg-slate-900/60 p-4 rounded-xl border border-slate-800">
            {aiSummaryExplanation || 'Comprehensive rationale generated by SmartyHire AI Engine.'}
          </p>
        </div>
