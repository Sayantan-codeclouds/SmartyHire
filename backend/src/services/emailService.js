...
const sendInterviewInviteEmail = async (candidateName, candidateEmail, interviewTitle, companyName, publicId) => {
  ...
  <div style="font-family: 'Plus Jakarta Sans', Arial, sans-serif; background-color: #0B0F17; padding: 40px; color: #F8FAFC;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #0D131F; border-radius: 16px; padding: 36px; border: 1px solid rgba(255,255,255,0.1);">
      ...
      <p style="font-size: 14px; color: #CBD5E1; line-height: 1.6;">You have been invited to take an autonomous Groq AI Voice Interview for the position of <strong>${interviewTitle}</strong> at <strong>${companyName}</strong>.</p>
      ...
      <p style="font-size: 12px; color: #64748B; margin: 0;">Powered by SmartyHire AI • Groq Speech & Proctoring Engine</p>
    </div>
  </div>
  `;
...
const sendWelcomeCompanyEmail = async (adminName, adminEmail, companyName) => {
  ...
  <div style="font-family: 'Plus Jakarta Sans', Arial, sans-serif; background-color: #0B0F17; padding: 40px; color: #F8FAFC;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #0D131F; border-radius: 16px; padding: 36px; border: 1px solid rgba(255,255,255,0.1);">
      ...
      <p style="font-size: 14px; color: #CBD5E1; line-height: 1.6;">Your company workspace <strong>${companyName}</strong> has been successfully created and configured with live Groq GPT-OSS 120b AI interviewing capabilities.</p>
  ...
  <div style="font-family: 'Plus Jakarta Sans', Arial, sans-serif; background-color: #0B0F17; padding: 40px; color: #F8FAFC;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #0D131F; border-radius: 16px; padding: 36px; border: 1px solid rgba(255,255,255,0.1);">
      ...
      <p style="font-size: 14px; color: #CBD5E1; line-height: 1.6;">
        ...
        The AI evaluation scorecard is now being generated by the Groq engine.
      </p>
      ...
      <hr style="border: 0; border-top: 1px solid #1E293B; margin: 28px 0;" />
      <p style="font-size: 12px; color: #64748B; margin: 0;">Powered by SmartyHire AI • Groq AI Engine</p>
    </div>
  </div>
  `;
